    ...
    >
      <div
        className={[
          ...
          isLanding
            ? "min-h-11 max-w-7xl rounded-lg border border-line-steel/45 bg-surface-1/42 px-4 py-2.5 shadow-[inset_0_1px_0_rgba(217,226,240,0.05)]"
            : "min-h-11 md:h-full",
        ].join(" ")}
      >
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          ...
          <nav className={isLanding ? "hidden items-center gap-1 sm:flex" : "flex items-center gap-1 md:hidden"}>
