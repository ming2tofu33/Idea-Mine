...
/**
 * Guest-facing lab demo. Reuses the real lab rows with static sample data and
 * routes clicks to sign-in.
 */
export function DemoLab() {
  ...
  const ideasWithoutOverview = ideas.filter((idea) => !overviewMap[idea.id]);
  const ideasWithOverview = ideas.filter((idea) => overviewMap[idea.id]);
