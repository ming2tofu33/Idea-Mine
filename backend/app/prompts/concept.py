def build_concept_prompt(
    ...
    return f"""You are defining a product concept from keyword combinations.
...
{{{{
  "concept_en": "A [TECH] for [WHO]...",
  "concept_ko": "한국어 한 줄 컨셉",
  "product_type": "B2C" or "B2B",
  "primary_user_en": "plain language description of WHO",
  "primary_user_ko": "한국어 WHO 설명",
  "core_experience_en": "The user opens the app and...",
  "core_experience_ko": "사용자가 앱을 열고..."
}}}}"""
