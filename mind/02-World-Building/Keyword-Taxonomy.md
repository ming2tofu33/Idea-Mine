...
| 등급 | 이름 | 색상 | 조건 |
|------|------|------|------|
| Common | 일반 광맥 | 회청 | 기본 키워드 풀, 자연스러운 조합. 상시 등장 |
| Rare | 레어 광맥 | 보라+purpleGlow | 기본 키워드 풀이지만 **의외한 조합** (subtype 교차). 상시 등장 |
| Golden | 금빛 광맥 | 골드+goldGlow | 트렌드 키워드 1개 이상 포함 |
| Legend | 전설 광맥 | 다이아(시안/화이트)+diamondGlow | 시즌 한정 키워드 포함 |
...
- AI 보정 시스템으로 품질 관리 (임베딩 유사도 우선, GPT-5-nano 폴백)
