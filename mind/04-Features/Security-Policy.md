...
| 5 | 공개 콘텐츠 보호 | 쇼케이스/거래소 아이디어 대량 스크래핑 | 중간 | Phase 3+ | 미구현 |
...
- [[Admin-Persona]] -- admin 계정 구조, RLS 보호, role 변경 차단
- [[Admin-Dashboard]] -- admin 모니터링 대시보드 보안 설계
